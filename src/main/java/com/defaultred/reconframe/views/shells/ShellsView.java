package com.defaultred.reconframe.views.shells;
...
@PageTitle("Shells")
@Route(value = "shells", layout = MainLayout.class)
public class ShellsView extends HorizontalLayout {
    ...
    public ShellsView() {
        addClassNames("shells-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
